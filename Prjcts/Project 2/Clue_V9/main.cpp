 ...
 *
 * Created on February 9, 2022, 1:23 PM
 * Purpose: Clue V9
 */
...
void sus(vector<string>, vector<string>, vector<string>, vector<string>, string [][COL]);
                    ...
                    if(ch == 'y' || ch == 'Y'){  //Provide list of suspect
                        ...
                        if(choice < 6){  //Character suspect
                            ...
                            if(choice - 12 != slct3){
                                ...
                                //Add room to vector
                                guilty.push_back(cha[choice - 12]);
                            }
                        }
...
void sus(vector<string> cha, vector<string> wpon, vector<string> room, vector<string> guilt, string spect[][COL]){
