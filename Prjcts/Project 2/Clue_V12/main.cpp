 ...
 *
 * Created on February 10, 2022, 8:41 AM
 * Purpose: Clue V12
 */
...
int setLoc(char, int &, string[]);            //Set user position vertical and horizontal
void locRoom();                               //Display position of rooms
void print(string [], int);                   //Print string arrays 
void print(string [][4], int = 0, int = 0, int = 0, int = 0);  //Print 2 dimensional arrays
void selSort(vector<string> &);
void bubSort(vector<string> &);
